...
import 'package:no_repeat/src/information/archives/data_domain_scheme.dart';
import 'package:no_repeat/src/information/archives/data_other_scheme.dart';
import 'package:no_repeat/src/information/archives/data_utils_scheme.dart';
import 'package:no_repeat/src/information/info.dart';
import 'package:no_repeat/src/log.dart';
import 'architecture/architecture.dart';
import 'file_tools.dart';
import 'information/archives/data_application_scheme.dart';
import 'information/archives/data_infrastructure_scheme.dart';
import 'information/archives/data_injection_scheme.dart';
import 'information/archives/data_presentation_scheme.dart';
...
List<FileInfo> _getDomainFiles() {
  ...
  files.add(FileInfo(
      ...
      extension: '.dart',
      folder: Folder(getArchitecturePath())
          .add(Folder(path).add(Folder('core').add(Folder('network')))),
      content: ABSTRACT_NETWORK_INFO_SCHEME));
...
List<FileInfo> _getInfrastructureFiles() {
  ...
  files.add(FileInfo(
      className: 'default_network_info',
      extension: '.dart',
      folder: Folder(getArchitecturePath())
          .add(Folder(path).add(Folder('core').add(Folder('network')))),
      content: IMPLEMENTATION_NETWORK_INFO_SCHEME.replaceAll(
          'packageName', package)));
